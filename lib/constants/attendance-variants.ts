...
export type AttendanceVariantType = "secondary" | "outline" | "destructive" | "default" | "success" | null | undefined;

export type AttendanceType = 'present' | 'absent' | 'late';

// Badge variants mapping for use with the Badge component
export const attendanceBadgeVariants: Record<AttendanceType, AttendanceVariantType> = {
  present: 'success',
  absent: 'destructive',
  late: 'outline',
};
...
export const attendanceColorClasses: Record<AttendanceType, { bg: string, text: string }> = {
...
export const getAttendanceStatus = (isPresent: boolean, time: string | null): AttendanceType => {
