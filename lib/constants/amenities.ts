...
export const PREDEFINED_AMENITY_CATEGORIES: AmenityCategoryDefinition[] = [
	{
		...
		amenities: [
			...
			},
			{
				...
				description: 'TRX, kettlebells, battle ropes',
			},
			{
				key: 'squat-racks',
				name: 'Squat Racks',
				description: 'Power racks and squat stands',
			},
			{
				key: 'smith-machine',
				name: 'Smith Machine',
		...
		amenities: [
			{
				key: 'yoga-classes',
				name: 'Yoga Classes',
				description: 'Various yoga styles and levels',
			},
			{
				key: 'pilates',
				name: 'Pilates',
				description: 'Mat and equipment pilates',
			},
			...
			},
			{
				key: 'martial-arts',
				name: 'Martial Arts',
				description: 'Boxing, kickboxing, MMA',
			},
			{
				key: 'dance-classes',
				name: 'Dance Classes',
	...
	},
	{
		...
		amenities: [
			{ key: 'sauna', name: 'Sauna', description: 'Dry heat sauna facilities' },
			{
				key: 'steam-room',
				name: 'Steam Room',
				description: 'Wet steam facilities',
			},
			{
				key: 'massage-therapy',
			...
			},
			{
				key: 'cryotherapy',
				name: 'Cryotherapy',
				description: 'Cold therapy treatments',
			},
			{
				key: 'infrared-therapy',
				name: 'Infrared Therapy',
				description: 'Infrared light treatments',
			},
		],
	},
	{
		...
		amenities: [
			...
			},
			{
				key: 'lap-pool',
				name: 'Lap Pool',
				description: 'Dedicated lanes for swimming laps',
			},
			{
				key: 'hot-tub',
				name: 'Hot Tub/Jacuzzi',
				description: 'Heated water therapy',
			},
			{
				key: 'water-aerobics',
				name: 'Water Aerobics',
				description: 'Aquatic fitness classes',
			},
			{
				key: 'kids-pool',
				name: 'Kids Pool',
				description: "Children's swimming area",
			},
		],
	},
	{
		...
		amenities: [
			{
				key: 'childcare',
				name: 'Childcare',
				description: 'On-site childcare services',
			},
			{
				key: 'kids-programs',
				name: 'Kids Programs',
				description: 'Youth fitness and activities',
			},
			{
				key: 'family-changing',
				name: 'Family Changing Rooms',
				description: 'Family-friendly facilities',
			},
			{
				key: 'juice-bar',
				name: 'Juice Bar',
				description: 'Healthy drinks and smoothies',
			},
			{
				key: 'pro-shop',
				name: 'Pro Shop',
				description: 'Fitness gear and supplements',
			},
	...
	},
	{
		...
		amenities: [
			...
			{
				key: 'nutrition-counseling',
				name: 'Nutrition Counseling',
				description: 'Dietary guidance and planning',
			},
			{
				key: 'body-composition',
				name: 'Body Composition Analysis',
				description: 'InBody or DEXA scans',
			},
			{
				key: '24-7-access',
				name: '24/7 Access',
			...
			},
			{
				key: 'guest-passes',
				name: 'Guest Passes',
				description: 'Bring-a-friend privileges',
			},
			{
				key: 'towel-service',
				name: 'Towel Service',
...
export function findAmenityByKey(
	key: string,
): (AmenityDefinition & { categoryKey: string }) | undefined {
...
export function findCategoryByKey(
	key: string,
): AmenityCategoryDefinition | undefined {
