...
import { buildGroceryListPrompt, validateGroceryList, type GroceryListResponse } from './prompts/grocery-list-prompts';
...
export async function generateGroceryList(
  ...
  try {
    ...
    try {
      ...
      console.warn("First attempt failed, trying fallback approach:", firstAttemptError);
    }
