...
export default function ReligiousDisplay({ data }: ReligiousDisplayProps) {
  ...
  const badgeClass = religiousPreferenceColors[religiousPreference as keyof typeof religiousPreferenceColors] || 'bg-gray-100 text-gray-800';
      ...
      <CardContent className="p-6">
        <div className="flex flex-col space-y-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-gray-700">Religious Preference</span>
          </div>
          ...
          <div className="flex items-center flex-wrap gap-2">
            ...
            {data.religiousPreference === 'Other' && data.otherReligiousPreference && (
              <span className="text-sm text-gray-600">({data.otherReligiousPreference})</span>
            )}
          </div>
          
          <div className="mt-4 pt-4 border-t border-dashed border-gray-200">
            <p className="text-xs text-gray-500 italic">
              Religious preferences help us respect cultural and dietary requirements during meal planning and workout scheduling.
            </p>
          </div>
        </div>
      </CardContent>
