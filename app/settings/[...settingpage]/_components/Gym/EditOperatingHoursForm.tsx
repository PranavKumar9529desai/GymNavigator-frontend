...
export default function EditOperatingHoursForm({
  ...
  const handleChange = (period: keyof OperatingHours, field: keyof TimeSlot, value: string) => {
    setFormData(prev => ({
      ...prev,
      [period]: {
        ...prev[period],
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleChange("weekdays", "openingTime", e.target.value)}
                required
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleChange("weekdays", "closingTime", e.target.value)}
                required
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleChange("weekends", "openingTime", e.target.value)}
                required
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleChange("weekends", "closingTime", e.target.value)}
                required
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleChange("holidays", "openingTime", e.target.value)}
                required
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleChange("holidays", "closingTime", e.target.value)}
                required
              />
            </div>
          </div>
