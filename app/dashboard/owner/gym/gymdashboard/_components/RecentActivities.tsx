			...
			<CardContent>
				<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
					<div>
						...
						<div className="space-y-2">
							{recentActivities.recentSignups.slice(0, 5).map((signup) => (
								<div
									key={signup.id}
									className="flex items-center space-x-2 p-2 bg-gradient-to-r from-emerald-50/50 to-teal-50/50 rounded border border-emerald-100"
								>
						...
						<div className="space-y-2">
							{recentActivities.recentAttendance
								...
								.map((attendance) => (
									<div
										key={attendance.id}
										className="flex items-center space-x-2 p-2 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 rounded border border-blue-100"
									>
					...
					<div>
						...
						<div className="space-y-2">
							{recentActivities.recentTrainerAssignments
								.slice(0, 5)
								.map((assignment) => (
									<div
										key={assignment.id}
										className="flex items-center space-x-2 p-2 bg-gradient-to-r from-purple-50/50 to-pink-50/50 rounded border border-purple-100"
									>
