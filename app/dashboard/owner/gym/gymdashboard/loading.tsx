		...
		<div className="space-y-4 p-4 bg-gradient-to-br from-blue-50/40 via-white to-indigo-50/30 min-h-screen">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
				{['revenue', 'members', 'attendance', 'trainers'].map((metric) => (
					<div
						key={metric}
						className="border border-blue-200 bg-white/80 rounded-lg p-4 shadow-sm"
					>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
				...
				<div className="border border-blue-200 bg-white/80 rounded-lg p-4 shadow-sm">
					...
					<div className="space-y-3">
						{['onboarding', 'health-profile', 'ready', 'fully-onboarded'].map(
							(stage) => (
				...
				<div className="border border-blue-200 bg-white/80 rounded-lg p-4 shadow-sm">
					...
					<div className="space-y-2">
						{['trainer-1', 'trainer-2', 'trainer-3'].map((trainer) => (
							<div
								key={trainer}
								className="flex items-center justify-between p-2 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 rounded-lg border border-blue-100"
							>
