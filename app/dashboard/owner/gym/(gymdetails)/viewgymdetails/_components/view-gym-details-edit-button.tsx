...
interface ViewGymDetailsEditButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  tooltip?: string;
}
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          ...
          {...props}
        >
          <Edit className="mr-2 text-blue-600 group-hover:text-blue-700 transition-colors" aria-hidden="true" />
