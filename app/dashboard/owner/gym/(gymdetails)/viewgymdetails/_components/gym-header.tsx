								...
								<div className="relative inline-block">
									...
									<TooltipProvider>
										<Tooltip>
											...
											<TooltipContent
												side="top"
												className="relative -top-20 -right-40 flex items-center gap-2 bg-gradient-to-r from-yellow-200 via-yellow-100 to-yellow-300 border border-yellow-400 shadow-lg rounded-xl font-semibold text-yellow-900 px-4 py-2"
											>
