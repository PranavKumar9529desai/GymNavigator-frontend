			...
			<div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
					...
					<CardContent className="p-3 sm:p-4">
						<div className="text-center">
							<p className="text-xl sm:text-2xl font-bold">
								{displayData(healthData.weight, ' kg')}
							</p>
				...
				<Card>
					<CardContent className="p-3 sm:p-4">
						<div className="text-center">
							<p className="text-xl sm:text-2xl font-bold">
								{displayData(healthData.height, ' cm')}
							</p>
				...
				<Card>
					<CardContent className="p-3 sm:p-4">
						<div className="text-center">
							<p className="text-xl sm:text-2xl font-bold">
								{displayData(healthData.bodyFat, '%')}
							</p>
					...
					<CardContent className="space-y-4">
						<div>
							<div className="flex justify-between text-sm mb-2">
								...
								<span>
									{displayData(healthData.weight, 'kg')} /{' '}
									{displayData(healthData.goals?.weightGoal, 'kg')}
								</span>
							</div>
							<Progress
								value={
						...
						<div>
							<div className="flex justify-between text-sm mb-2">
								...
								<span>
									{displayData(healthData.bodyFat, '%')} /{' '}
									{displayData(healthData.goals?.bodyFatGoal, '%')}
								</span>
							</div>
							<Progress
								value={
						...
						<div>
							...
							<Progress
								value={healthData.muscleMass ? 75 : 0}
								className="h-2"
							/>
						</div>
					</CardContent>
