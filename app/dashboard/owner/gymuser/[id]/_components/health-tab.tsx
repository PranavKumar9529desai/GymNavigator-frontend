    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <Card>
          <CardContent className="p-3 sm:p-4">
            <div className="text-center">
              <p className="text-xl sm:text-2xl font-bold">{healthData.weight} kg</p>
        ...
        <Card>
          <CardContent className="p-3 sm:p-4">
            <div className="text-center">
              <p className="text-xl sm:text-2xl font-bold">{healthData.height} cm</p>
        ...
        <Card>
          <CardContent className="p-3 sm:p-4">
            <div className="text-center">
              <p className="text-xl sm:text-2xl font-bold">{healthData.bmi}</p>
        ...
        <Card>
          <CardContent className="p-3 sm:p-4">
            <div className="text-center">
              <p className="text-xl sm:text-2xl font-bold">{healthData.bodyFat}%</p>
          ...
          <CardContent className="space-y-4">
            <div>
              <div className="flex justify-between text-sm mb-2">
                ...
                <span>
                  {healthData.weight}kg / {healthData.goals.weightGoal}kg
                </span>
              </div>
              <Progress value={(healthData.weight / healthData.goals.weightGoal) * 100} className="h-2" />
            </div>
            <div>
              <div className="flex justify-between text-sm mb-2">
              ...
              <Progress
                value={((healthData.bodyFat - healthData.goals.bodyFatGoal) / healthData.bodyFat) * 100}
                className="h-2"
              />
            </div>
            <div>
              <div className="flex justify-between text-sm mb-2">
                ...
                <span>{healthData.muscleMass}kg</span>
              </div>
