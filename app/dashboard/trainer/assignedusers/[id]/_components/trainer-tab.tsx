...
export function TrainerTab({ trainerData }: TrainerTabProps) {
  ...
  const openWhatsApp = (type: 'call' | 'message') => {
    ...
    let message = '';
    if (type === 'call') {
      message = encodeURIComponent(`Hi ${trainerName}, I'd like to schedule a call with you regarding my fitness training.`);
    } else {
      message = encodeURIComponent(`Hi ${trainerName}, I have a question about my fitness training. Could you please help me?`);
    }
