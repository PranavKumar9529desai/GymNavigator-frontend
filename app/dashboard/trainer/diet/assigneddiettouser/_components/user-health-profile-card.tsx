...
export function UserHealthProfileCard({ userProfile }: UserHealthProfileCardProps) {
  ...
  const medicalConditions = health ? parseJsonSafely(health.medicalConditions) : [];
  ...
  const bmi = health?.bmi || (health ? calculateBMI(health.weightValue, health.heightValue, health.heightUnit) : 0);
      ...
      <Card className="border-orange-200 bg-orange-50/50">
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-lg text-orange-800">Health Profile Missing</CardTitle>
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-sm text-orange-700">
            Ask the user to complete their health profile before assigning a diet plan.
          </p>
        </CardContent>
      </Card>
    );
    ...
    <Card className="border-blue-100">
      <CardHeader>
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-lg text-slate-800">Health Profile</CardTitle>
            <CardDescription>Complete health information for {userProfile.name}</CardDescription>
          </div>
        </div>
      </CardHeader>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <div className="pl-6 space-y-1">
              <p className="text-sm"><span className="font-medium">Age:</span> {health.age} years</p>
              <p className="text-sm"><span className="font-medium">Gender:</span> {health.gender}</p>
            </div>
          </div>
        ...
        <div className="space-y-3">
          ...
          <div className="pl-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="p-3 bg-blue-50/50 rounded-lg">
              ...
              <p className="text-sm font-semibold">{health.weightValue} {health.weightUnit}</p>
            </div>
            <div className="p-3 bg-blue-50/50 rounded-lg">
              <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-sm font-semibold">{health.heightValue} {health.heightUnit}</p>
            </div>
            <div className="p-3 bg-blue-50/50 rounded-lg">
              <div className="flex items-center gap-2 mb-1">
              ...
              <div className="space-y-1">
                ...
                <Badge className={`text-xs ${bmiInfo.color}`} variant="secondary">
                  {bmiInfo.category}
                </Badge>
              </div>
            </div>
        ...
        {userProfile.dietPlan && (
          <div className="p-4 bg-yellow-50/50 border border-yellow-200 rounded-lg">
            <div className="flex items-center gap-2 text-yellow-800 mb-2">
              <Utensils className="h-4 w-4" />
              <span className="text-sm font-medium">Currently Assigned Diet</span>
            </div>
            <p className="text-sm font-semibold text-yellow-900">{userProfile.dietPlan.name}</p>
            {userProfile.dietPlan.description && (
              <p className="text-xs text-yellow-700 mt-1">{userProfile.dietPlan.description}</p>
            )}
          </div>
        )}
      </CardContent>
