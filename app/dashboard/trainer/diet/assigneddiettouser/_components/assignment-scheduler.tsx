		...
		<div className="space-y-6">
				...
				<div className="flex items-center gap-3">
					...
					<div>
						...
						<p className="text-slate-600">
							Configure when the diet plan should be active
						</p>
					</div>
				</div>
			</div>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Set the start and end dates for the diet plan
						</CardDescription>
					</CardHeader>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Select which days of the week the diet plan should be followed
						</CardDescription>
					</CardHeader>
					<CardContent className="space-y-4">
								...
								{DAYS_OF_WEEK.map((day) => {
									...
									return (
										<button
											...
											type="button"
											className={cn(
												'p-3 border rounded-lg cursor-pointer transition-colors w-full text-left',
												isSelected
							...
							<div className="p-3 bg-blue-50/50 border border-blue-200 rounded-lg">
								<div className="flex items-center gap-2 mb-2">
									...
									<span className="text-sm font-medium text-blue-700">
										Active on {selectedDays.length} day
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Add any special instructions or notes for the diet plan assignment
					</CardDescription>
				</CardHeader>
				<CardContent>
					<Textarea
			...
			<div className="flex gap-3 pt-4">
				...
				<Button
					...
					disabled={
						isLoading || selectedDays.length === 0 || !startDate || !endDate
					}
