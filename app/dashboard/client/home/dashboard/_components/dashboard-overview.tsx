					...
					<div className="p-4 rounded-lg bg-background border hover:shadow-sm transition-shadow">
						<div className="space-y-2">
							...
							<div className="space-y-2">
								...
								<Progress
									value={attendance.monthlyPercentage}
								...
								<Badge
									...
									className="border-blue-200 text-blue-700 text-xs"
								>
									{attendance.monthlyPercentage >= 80
										? 'Excellent'
										: attendance.monthlyPercentage >= 60
											? 'Good'
											: 'Keep Going'}
								</Badge>
							</div>
				...
				{expandedSections.actions && (
					<div className="pb-3">
						<div className="grid grid-cols-2 md:grid-cols-4 gap-2">
							<Button className="h-20 flex-col gap-2 border-blue-200 text-blue-600 hover:bg-blue-50">
						...
						<div className="space-y-1">
							{attendance.recentAttendances.length > 0 ? (
								attendance.recentAttendances.map((record, index) => (
									<div
										key={index as number}
										className="flex items-center justify-between p-2 hover:bg-blue-50/30 rounded transition-colors"
									>
										<div className="flex items-center gap-3">
											<div
												className={cn(
