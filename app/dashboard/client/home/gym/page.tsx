export default function GymPage() {
  return (
    ...
    <div className="h-screen overflow-y-auto">
      ...
      <div className="sticky top-0 z-10 bg-green-400 p-4 shadow"> {/* Added sticky here */}
        Sticky Header Part (Green) - Always Visible
      </div>

      {/* Main Scrollable Content */}
      <div className="bg-gray-100 p-4 min-h-screen"> {/* Added min-h-screen and more content */}
        ...
        Content Line 29<br />
        Content Line 30<br />
        Even more content to ensure scrolling...<br />
        Even more content to ensure scrolling...<br />
        Even more content to ensure scrolling...<br />
        Even more content to ensure scrolling...<br />
        End of Content
