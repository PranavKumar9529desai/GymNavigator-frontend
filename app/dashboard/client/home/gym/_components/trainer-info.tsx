...
export function TrainerInfo({ trainer }: TrainerInfoProps) {
  ...
  const openWhatsApp = () => {
    ...
    const message = encodeURIComponent(`Hi ${trainerName}, I hope you're doing well! I have some questions about my fitness training and would appreciate your guidance. Could you please help me?`);
