		...
		<div className="w-full">
			...
			<div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
				<div className="p-6 text-center">
					<div
						className="mx-auto relative w-full aspect-square mb-6"
					...
					<p className="text-gray-600 mx-auto text-base">
						Your trainer hasn't assigned any workouts to you yet. Check back
						later or contact your trainer for more information.
					</p>
				</div>
			</div>
		</div>
