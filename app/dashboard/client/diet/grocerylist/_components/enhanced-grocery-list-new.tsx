      ...
      <CardHeader className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pb-2 print:hidden">
        <div>
          ...
          <div className="text-sm text-muted-foreground mt-1">
            {totalItems} items total • {totalPurchased} purchased ({progress}% complete)
          </div>
        </div>
      ...
      <CardContent className="p-4 pt-0">
        ...
        <div className="flex flex-col md:flex-row gap-2 mb-4 print:hidden">
          ...
          <div className="flex gap-2">
            ...
            <Button 
              variant={filterPurchased === 'unpurchased' ? "default" : "outline"} 
              size="sm" 
        ...
        {filteredCategories.length === 0 && (
          <div className="flex flex-col items-center justify-center py-10 text-center">
            ...
            <p className="text-muted-foreground mt-1">
              {searchQuery ? "Try using different search terms" : "Your grocery list is empty"}
            </p>
          </div>
        )}
