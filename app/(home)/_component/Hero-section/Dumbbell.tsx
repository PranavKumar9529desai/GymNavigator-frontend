...
const BASE_ANIM_AMP_X = 36; // Further reduced movement
const BASE_ANIM_AMP_Y = 36; // Further reduced movement
const BASE_ANIM_AMP_Z = 35; // Make Z wobble very minimal
const MOUSE_SENSITIVITY_X = 5; // More responsive movement
const MOUSE_SENSITIVITY_Y = 8; // More responsive movement
const MOUSE_SENSITIVITY_Z = 15; // More responsive Z movement
